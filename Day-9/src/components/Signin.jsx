...
import { Avatar, Box, Button, IconButton, InputAdornment, Link, Paper, TextField, Typography } from '@mui/material'
            ...
            <Paper sx={{ display: 'inline-block', padding: '4rem 3rem 3rem 3rem', overflow: 'hidden'}} elevation={3}>
                ...
                >
                    <Box sx={{ display: 'flex', justifyContent: 'center', paddingBottom: '2rem' }}>
                        ...
                        <Typography sx={{ fontWeight: 700, fontSize: '48px' }}>Create Account</Typography>
                    </Box>
